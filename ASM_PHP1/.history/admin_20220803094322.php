...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `products`(product_name, product_image, product_price, product_desc) VALUES('$product_name', '$product_price', ' $product_image',  '$product_desc')") or die('query failed');
