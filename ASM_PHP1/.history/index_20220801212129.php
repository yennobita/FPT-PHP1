...
<html lang="en">
  ...
  <body>
    ...
    <?php
$sql ="SELECT product_code, product_name, product_desc, product_img_name, price FROM products ORDER BY id ASC";
...
while($rs = $results->fetch())
{
	...
	<div class="product-thumb"><img src="images/<?php echo $rs['product_img_name'] ?>"></div>
	<div class="product-desc"><?php echo $rs['product_desc'] ?></div>
	<div class="product-info">
	Price <?php echo $currency ?><?php echo $rs['price'] ?> 
	...
	<input type="hidden" name="product_code" value="<?php echo $rs['product_code'] ?>" />
