...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `products`(product_name, product_price, product_image, product_desc) VALUES('$product_name', '$product_price', ' $product_image',  '$product_desc')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `products` SET product_name = '$update_p_name', product_price = '$update_p_price', product_image = '$update_p_image', $product_desc = '$update_p_desc' WHERE id = '$update_p_id'");
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   ...
   <input type="text" name="product_desc" placeholder="enter the product desc" class="box" required>
...
<section class="display-product-table">
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            <td><img src="uploaded_img/<?php $row['product_image']; ?>" height="100" alt=""></td>
