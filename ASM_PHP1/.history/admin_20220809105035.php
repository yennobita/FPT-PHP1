...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `products`(product_name, product_price, product_image, product_desc) VALUES('$p_name', '$p_price', '$p_image', '$p_desc')") or die('query failed');
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   ...
   <textarea name="p_desc" id="" cols="30" rows="10" placeholder="enter the product desc" require></textarea>
