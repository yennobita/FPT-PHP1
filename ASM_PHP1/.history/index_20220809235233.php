...
?>
    ...
    <header class="header">
      ...
      <a href="login_form.php"><div id="user-btn" class="fas fa-user icons icon-pd"></div></a>
      <!-- <a id="menu-profile" class="fas fa-user icons icon-pd"></a> -->
...
<section class="blogs" id="blogs">
   ...
   <div class="box-container">
      ...
      <div class="box" data-aos="fade-up" data-aos-delay="300">
         ...
         <div class="content">
            <h3>Chicken burger sauce</h3>
            <p>Sauces made with a blend can become a staple in your kitchen.</p>
            <a href="#" class="btn">read more</a>
         </div>
      </div>
