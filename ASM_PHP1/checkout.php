...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($conn, "INSERT INTO `khachhang`(TenKhachHang, Sodienthoai, Email, method, DiaChi) VALUES('$name','$number','$email','$method','$address')") or die('query failed');
